...
Retained v3 receipt IDs are resolved through canonical readReceiptById(receiptId)
and its returned run_id, followed by readReceiptChain(runId); snapshot locators
and receipt enumeration are not authoritative.
