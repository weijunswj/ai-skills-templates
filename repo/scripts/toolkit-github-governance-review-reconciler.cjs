...
function createRuntime(options = {}) {
  ...
  return Object.freeze({
    ...
    programmeV5: Object.freeze({
      ...
      renderHuman: programmeV5.renderHumanPresentation,
      renderCurrent: programmeV5.renderCurrentHuman,
      renderHumanPresentation: programmeV5.renderHumanPresentation,
      buildPresentationModel: programmeV5.buildPresentationModel,
    }),
  });
}
...
module.exports = Object.freeze({
  ...
  HUMAN_PRESENTATION_SCHEMA: programmeV5.HUMAN_PRESENTATION_SCHEMA,
  HUMAN_PRESENTATION_VERSION: programmeV5.HUMAN_PRESENTATION_VERSION,
  HUMAN_PR_PRESENTATION_SCHEMA: programmeV5.HUMAN_PR_PRESENTATION_SCHEMA,
  HUMAN_HISTORY_DECISION_SCHEMA: programmeV5.HUMAN_HISTORY_DECISION_SCHEMA,
  HUMAN_HISTORY_EVIDENCE_SCHEMA: programmeV5.HUMAN_HISTORY_EVIDENCE_SCHEMA,
  buildPresentationModel: programmeV5.buildPresentationModel,
  normalizePresentationModel: programmeV5.normalizePresentationModel,
  validatePresentationModel: programmeV5.validatePresentationModel,
  adaptToolkitV5ToPresentation: programmeV5.adaptToolkitV5ToPresentation,
  toolkitV5PresentationAdapter: programmeV5.toolkitV5PresentationAdapter,
  renderPresentationModel: programmeV5.renderPresentationModel,
  renderHumanPresentation: programmeV5.renderHumanPresentation,
  renderProgrammeHuman: programmeV5.renderProgrammeHuman,
  renderCurrentHuman: programmeV5.renderCurrentHuman,
  renderHuman: programmeV5.renderHuman,
  renderHumanParent: programmeV5.renderHumanParent,
  renderHumanChild: programmeV5.renderHumanChild,
  renderParentHumanBody: programmeV5.renderParentHumanBody,
  renderChildHumanBody: programmeV5.renderChildHumanBody,
  parsePresentationBody: programmeV5.parsePresentationBody,
  parseHumanPresentationBody: programmeV5.parseHumanPresentationBody,
  parseHumanParentBody: programmeV5.parseHumanParentBody,
  parseHumanChildBody: programmeV5.parseHumanChildBody,
  renderHumanPrBody: programmeV5.renderHumanPrBody,
  renderPrPresentation: programmeV5.renderPrPresentation,
  normalizePrPresentationModel: programmeV5.normalizePrPresentationModel,
  bindHumanPrNumber: programmeV5.bindHumanPrNumber,
  parseHumanPrBody: programmeV5.parseHumanPrBody,
  verifyHumanPrBodyIdentity: programmeV5.verifyHumanPrBodyIdentity,
  createHumanSurfaceConformanceDecision: programmeV5.createHumanSurfaceConformanceDecision,
  makeHumanSurfaceConformanceDecision: programmeV5.makeHumanSurfaceConformanceDecision,
  ...
  makeHumanSurfaceConformanceEvidence: programmeV5.makeHumanSurfaceConformanceEvidence,
  ...
  applyHumanSurfaceHistoryDecision: programmeV5.applyHumanSurfaceHistoryDecision,
  ...
  buildHumanHistoryTarget: programmeV5.buildHumanHistoryTarget,
  bindHistoryCandidateNumber: programmeV5.bindHistoryCandidateNumber,
});
