...
function current(supported, profile = {}) {
  const proof = { schema: 3, source: 'claude-plugin-list', plugin_version: '2.11.0', cache_identity: 'a'.repeat(64), hook_sha256: 'b'.repeat(64), controller_sha256: 'c'.repeat(64), process_launch_sha256: 'e'.repeat(64), agent_hook_sha256: 'd'.repeat(64) };
  return {
